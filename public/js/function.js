(function ($) {
	...
	if ($('.partner-logo-slider').length) {
		const partner_logo_slider = new Swiper('.partner-logo-slider .swiper', {
			slidesPerView : 2,
			speed: 2000,
			spaceBetween: 30,
			loop: true,
	...
	var $service_item_list_gold = $('.service-item-list-gold');
	if ($service_item_list_gold.length) {
		var $service_item_gold = $service_item_list_gold.find('.service-item-gold');
